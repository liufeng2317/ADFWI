...
- Added `examples/validation/marmousi2_acoustic_reduced/scripts/case_definition.py`
...
- `conda run -n adfwi python -m py_compile examples/validation/marmousi2_acoustic_reduced/scripts/case_definition.py examples/validation/marmousi2_acoustic_reduced/scripts/run_validation.py tests/test_marmousi2_validation_example.py`: passed.
