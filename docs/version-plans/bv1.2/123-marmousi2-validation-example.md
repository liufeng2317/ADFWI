...
- Added `examples/validation/marmousi2_acoustic_bv12/run_validation.py` with
...
- Added `examples/validation/marmousi2_acoustic_bv12/marmousi2_acoustic_bv12_validation.ipynb`.
...
- `conda run -n adfwi python -m py_compile examples/validation/marmousi2_acoustic_bv12/run_validation.py tests/test_marmousi2_validation_example.py`: passed.
- `conda run -n adfwi python -m unittest tests/test_marmousi2_validation_example.py`: passed.
- `conda run -n adfwi python examples/validation/marmousi2_acoustic_bv12/run_validation.py all --device cpu --dry-run`: passed.
