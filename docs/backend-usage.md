...
`ADFWI.fwi.iteration.batches`, `ADFWI.fwi.iteration.loss`, or
...
`ADFWI.fwi.iteration.loss`, because they are all part of batch loss
construction. Shot batch scheduling belongs to `ADFWI.fwi.iteration.batches`.
