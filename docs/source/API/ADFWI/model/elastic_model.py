...
class IsotropicElasticModel(AbstractModel):
    ...
    vp_bound : Optional[Tuple[float, float]], optional
        The lower and upper bounds for the P-wave velocity model, default is None
    vs_bound : Optional[Tuple[float, float]], optional
        The lower and upper bounds for the S-wave velocity model, default is None
    rho_bound : Optional[Tuple[float, float]], optional
        The lower and upper bounds for the density model, default is None
    vp_grad : Optional[bool], optional
        A flag to indicate if the gradient of the P-wave velocity model is needed, default is False
    vs_grad : Optional[bool], optional
        A flag to indicate if the gradient of the S-wave velocity model is needed, default is False
    rho_grad : Optional[bool], optional
        A flag to indicate if the gradient of the density model is needed, default is False
    free_surface : Optional[bool], optional
        A flag to indicate the presence of a free surface in the model, default is False
    abc_type : Optional[str], optional
        The type of absorbing boundary condition used in the model, options include 'PML', 'Jerjan', etc., default is 'PML'
    abc_jerjan_alpha : Optional[float], optional
        The attenuation factor for the Jerjan boundary condition, default is 0.0053
    nabc : Optional[int], optional
        The number of grid cells dedicated to the absorbing boundary, default is 20
    auto_update_rho : Optional[bool], optional
        Whether to automatically update the density model during inversion, default is True
    ...
    water_layer_mask : Optional[Union[np.array, Tensor]], optional
        A mask for the water layer (not updated), if applicable, default is None
    device : str, optional
        The device on which to run the model, options are 'cpu' or 'cuda', default is 'cpu'
    dtype : torch.dtype, optional
        The data type for PyTorch tensors, default is torch.float32
    """
    def __init__(self,
                ox:float,oz:float,
                nx:int,nz:int,
