...
#########################################################################################
#               optimizer from swit (https://github.com/seisfwi/SWIT)
#########################################################################################
class Optimization(object):
    '''
        Optimization based on Fortran subroutines from SEISCOPE OPTIMIZATION TOOLBOX
    '''
    def __init__(self, niter_max = 20, conv = 1e-8, method = 'SD', 
                 bound = False, lb = None, ub = None, 
                 lbfgs_memory = 20, debug = False):
        '''
            ...
            method (str)        : optimization method, 'SD', 'CG', 'LBFGS', 'PLBFGS', 'TRN', 'PTRN'
            bound (bool)        : bound constraints, True or False
            lb (array)          : lower bound
            ub (array)          : upper bound
            lbfgs_memory (int)  : memory for LBFGS method
            debug (bool)        : debug mode, True or False
        '''
        ...
        self.alpha = 0.02                 # first value for the linesearch steplength
...
class Swit_Optimizer(Optimization):
    ...
    def __check__(self):
        ...
        methods = ['sd', 'pnlcg', 'lbfgs', 'plbfgs','lbfgs','adam']
