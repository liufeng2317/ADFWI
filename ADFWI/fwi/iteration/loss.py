"""Batch loss construction and backward steps for FWI iteration loops."""
...
def apply_elastic_batch_loss_step(
    *,
    ...
    ElasticFWI still owns the physical component choices. This helper only keeps
    forward execution, component loss evaluation, wavefield accumulation, and
    batch bookkeeping together for one batch.
    """
