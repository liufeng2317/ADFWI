...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.join(project_path,"inversion_tikhonov2"), exist_ok=True)
    ...
    regularization_fn = regularization_Tikhonov_2order(nx,nz,dx,dz,step_size=50,gamma=0.9)
