...
if __name__ == "__main__":
    ...
    from ADSWIT.fwi.misfit import Misfit_waveform_studentT
    ...
    plt.savefig(os.path.join(project_path,"inversion-StudentT/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,"inversion-StudentT/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path, "inversion-StudentT/inversion_process.gif"), writer='pillow', fps=10)
