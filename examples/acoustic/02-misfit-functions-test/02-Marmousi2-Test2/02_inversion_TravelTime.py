...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(project_path,"inversion-TravelTime/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,"inversion-TravelTime/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path, "inversion-TravelTime/inversion_process.gif"), writer='pillow', fps=10)
