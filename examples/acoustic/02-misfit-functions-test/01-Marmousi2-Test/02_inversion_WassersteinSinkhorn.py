...
if __name__ == "__main__":
    ...
    from ADSWIT.fwi.misfit import Misfit_wasserstein_sinkhorn
    ...
    plt.savefig(os.path.join(project_path,"inversion-Wasserstein_Sinkhorn/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,"inversion-Wasserstein_Sinkhorn/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path, "inversion-Wasserstein_Sinkhorn/inversion_process.gif"), writer='pillow', fps=10)
