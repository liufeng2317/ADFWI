...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(project_path,"inversion-NIM/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,"inversion-NIM/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path, "inversion-NIM/inversion_process.gif"), writer='pillow', fps=10)
