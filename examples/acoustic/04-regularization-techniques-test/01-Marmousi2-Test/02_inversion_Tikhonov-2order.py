...
if __name__ == "__main__":
    ...
    from ADSWIT.fwi.regularization import regularization_Tikhonov_2order
    ...
    plt.savefig(os.path.join(project_path,"inversion-Tikhonov2-order/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,"inversion-Tikhonov2-order/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path, "inversion-Tikhonov2-order/inversion_process.gif"), writer='pillow', fps=10)
