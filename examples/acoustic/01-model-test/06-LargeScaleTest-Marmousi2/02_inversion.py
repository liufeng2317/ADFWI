...
if __name__ == "__main__":
    ...
    nz, nx = 170, 400         # Grid dimensions in z and x directions
    dx, dz = 20, 20           # Grid spacing in x and z directions
    nt, dt = 2500, 0.002      # Time steps and time interval
    ...
    src_z = np.array([1 for i in range(2, nx-1, 10)])  # Z-coordinates for sources
    src_x = np.array([i for i in range(2, nx-1, 10)])  # X-coordinates for sources
