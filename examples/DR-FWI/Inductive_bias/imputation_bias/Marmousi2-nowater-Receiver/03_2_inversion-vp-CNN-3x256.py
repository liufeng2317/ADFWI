...
if __name__ == "__main__":
    ...
    elif settings["rcv_num"] == 50:
    # src = 50
        rcv_z = np.array([1 for i in range(0, nx, 4)])  # Z-coordinates for receivers
        rcv_x = np.array([j for j in range(0, nx, 4)])  # X-coordinates for receivers
    elif settings["rcv_num"] == 20:
    # src = 20
        rcv_z = np.array([1 for i in range(5, nx, 10)])  # Z-coordinates for receivers
        rcv_x = np.array([j for j in range(5, nx, 10)])  # X-coordinates for receivers
