...
if __name__ == "__main__":
    project_path = str(SCRIPT_DIR / "GC-GaussianNoise-for-all-Smooth=6/data-mean=1-std=3")
    ...
    os.makedirs(os.path.join(project_path,"inversion-vp-CNN-3x256-v"), exist_ok=True)
