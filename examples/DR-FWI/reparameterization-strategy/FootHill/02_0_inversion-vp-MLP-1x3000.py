...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(project_path,"statistic/inversion-vp-MLP-1x3000")):
        os.makedirs(os.path.join(project_path,"statistic/inversion-vp-MLP-1x3000"))
