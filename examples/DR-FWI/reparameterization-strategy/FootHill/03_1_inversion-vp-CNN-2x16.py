...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(project_path,"inversion-vp-CNN-2x16")):
        os.makedirs(os.path.join(project_path,"inversion-vp-CNN-2x16"))
    ...
    # -----------------------------------
    model_shape = [nz,nx]
    DIP_model_vp = DIP_CNN(model_shape,in_channels=[16,16],vmin=vp_true.min()/1000,vmax=vp_true.max()/1000,device=device)
