...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(project_path,"statistic/inversion-vp-Unet-1x256")):
        os.makedirs(os.path.join(project_path,"statistic/inversion-vp-Unet-1x256"))
