...
from ADFWI.utils import get_smooth_valhall_model, load_valhall_model, numpy2tensor, wavelet
...
if __name__ == "__main__":
    ...
    os.makedirs(os.path.join(project_path,f"inversion-vp-rho-MLP-3layer"), exist_ok=True)
    #------------------------------------------------------
    #                   Basic Parameters
    #------------------------------------------------------
    device = "npu:0"
    ...
    DIP_model_vp  = DIP_MLP(model_shape,random_state_num=100,hidden_layer_number=[100,100,100], out_channels_number=1,
                            vmins=[vp_true.min()/1000],vmaxs=[vp_true.max()/1000],units=[1000])
    DIP_model_rho = DIP_MLP(model_shape,random_state_num=100,hidden_layer_number=[100,100,100],out_channels_number = 1,
                            vmins=[rho_true.min()/1000],vmaxs=[rho_true.max()/1000],units=[1000])
