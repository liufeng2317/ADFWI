...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(project_path,f"inversion-vp-rho-MLP2-3layer")):
        os.makedirs(os.path.join(project_path,f"inversion-vp-rho-MLP2-3layer"))
