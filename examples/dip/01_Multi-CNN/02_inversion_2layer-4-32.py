...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(project_path,f"inversion-{layer_num}layer-4-32/misfit.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    plt.savefig(os.path.join(project_path,f"inversion-{layer_num}layer-4-32/inverted_res.png"),bbox_inches='tight',dpi=100)
    plt.close()
    ...
    ani.save(os.path.join(project_path,f"inversion-{layer_num}layer-4-32/inversion_process.gif"), writer='pillow', fps=10)
