...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(project_path,f"inversion-{layer_num}layer-4-32")):
        os.makedirs(os.path.join(project_path,f"inversion-{layer_num}layer-4-32"))
