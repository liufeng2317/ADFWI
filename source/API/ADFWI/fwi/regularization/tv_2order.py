...
class TV_2order(Regularization):
    ...
    \[
    \alpha_x \| L_1 m_x \|_2 + \alpha_z \| L_1 m_z \|_2
    \]
    Where \( L_1 \) is the second-order finite difference operator for the grid, and \( m_x \), \( m_z \) are the model components in the horizontal and vertical directions, respectively.
